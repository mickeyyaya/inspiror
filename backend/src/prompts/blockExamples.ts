...
### INTERACTIVE: Tap to Create (tap anywhere to spawn entities with burst + sound)
{
  "id": "tap-spawn",
  "type": "event",
  "label": "Tap to Create",
...
### INTERACTIVE: Drag to Move (touch-friendly drag-and-drop with visual feedback)
{
  "id": "drag-player",
  "type": "movement",
  "label": "Drag to Move",
...
### INTERACTIVE: Tap Sound (play a tone when tapping anywhere)
{
  "id": "tap-sound",
  "type": "sound",
  "label": "Tap Sound",
...
### INTERACTIVE: Tap to Change Color (add interaction to ANY passive animation)
{
  "id": "tap-color",
  "type": "event",
  "label": "Tap Color Change",
  "emoji": "🎨",
  "enabled": true,
  "params": [],
  "code": "var _colors = ['#FF6B9D', '#67E8F9', '#FDE047', '#C084FC', '#4ADE80', '#FFB86C'];\\nvar _ci = 0;\\ngame.onTapAnywhere('tap-color', function(x, y) {\\n  _ci = (_ci + 1) % _colors.length;\\n  game.setBackgroundGradient('radial', [_colors[_ci], _colors[(_ci + 2) % _colors.length]], 0);\\n  game.burst(x, y, { count: 15, spread: 5, color: _colors[_ci], shape: 'circle', life: 30 });\\n  game.shake(2, 100);\\n  game.playTone(300 + _ci * 100, 120, { type: 'sine', volume: 0.3 });\\n});",
  "order": 5
}
